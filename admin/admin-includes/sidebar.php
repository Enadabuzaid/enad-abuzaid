...
<a class="sidebar-brand d-flex align-items-center justify-content-center" href="<?php echo AD_PATH ?>">
    ...
    <div class="sidebar-brand-text mx-3">Enad Abuzaid</div>
</a>
...
<li class="nav-item">
    ...
    <div id="user" class="collapse" aria-labelledby="headingTwo" data-parent="#accordionSidebar">
        <div class="bg-white py-2 collapse-inner rounded">
            ...
            <a class="collapse-item" href="user-view.php">Users</a>
...
<li class="nav-item">
    <a class="nav-link collapsed" href="#" data-toggle="collapse" data-target="#about-me"
        aria-expanded="true" aria-controls="about-me">
        <i class="far fa-address-card"></i>
        <span>About Me</span>
    </a>
    <div id="about-me" class="collapse" aria-labelledby="headingTwo" data-parent="#accordionSidebar">
        <div class="bg-white py-2 collapse-inner rounded">
