...
$data = new Project();
$projects_types = $data->selectProjectType();


$title= "Project type | Data table";
$root = '../';
                            ...
                            <table class="table table-bordered text-center" id="dataTable" width="100%" cellspacing="0">
                                ...
                                foreach($projects_types as $projects_type){
                                    ...
                                    <tr>
                                        <td><?php echo $i++; ?></td>
                                        <td>
                                            <a href="<?php echo  "project_by_type.php?type_id=".$projects_type['project_type_id']?>">
                                                <?php echo $projects_type['project_type_name'];?>
                                            </a>
                                        </td>
                                        <td><?php echo $projects_type['project_target'];?></td>


                                        <td >
                                            <?php
                                            if($projects_type['project_type_status'] == 1) {
                                        ...
                                        <td>
                                            ...
                                            <a href="<?php echo  "project_by_type.php?type_id=".$projects_type['project_type_id']?>" class="btn-sm btn-success btn-icon-split">
                                                <span class="icon text-white-50">
